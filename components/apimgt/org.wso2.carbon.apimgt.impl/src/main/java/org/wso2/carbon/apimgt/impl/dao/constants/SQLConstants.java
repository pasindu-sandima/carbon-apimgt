...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String RETRIEVE_CORRELATION_CONFIG_PROPERTIES = "SELECT " +
            "AM_CORRELATION_CONFIG_PROPERTIES.PROPERTY_NAME , AM_CORRELATION_CONFIG_PROPERTIES.PROPERTY_VALUE " +
            "FROM AM_CORRELATION_CONFIG_PROPERTIES WHERE AM_CORRELATION_CONFIG_PROPERTIES.COMPONENT_NAME=?";

    public static final String UPDATE_CORRELATION_CONFIGS = "UPDATE AM_CORRELATION_CONFIGS SET ENABLED=? " +
            "WHERE COMPONENT_NAME=?";
    public static final String UPDATE_CORRELATION_CONFIG_PROPERTIES = "UPDATE AM_CORRELATION_CONFIG_PROPERTIES SET " +
